      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 grid size-7 place-items-center rounded-md text-slate-400 opacity-80 transition-colors hover:bg-slate-100 hover:text-slate-700 hover:opacity-100 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none data-[state=open]:bg-slate-100 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
